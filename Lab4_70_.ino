...
const int ci_Right_Line_Tracker = A0; //THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
const int ci_Middle_Line_Tracker = A1; //THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
const int ci_Left_Line_Tracker = A2; //THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
...
const int ci_Line_Tracker_Tolerance = 50;   // May need to adjust this (originally 50)
...
unsigned int ui_Motors_Speed = 1700;        // Default run speed ------------------------------------------------------------------------------------------ adjust this
...
void setup() {
  ...
  pinMode(ci_Left_Line_Tracker, INPUT); //herererererererererererererererererererehhhhhhhhhhhhhhggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggghaha
    ...
    case 1:    //Robot Run after 3 seconds
      {
        if (bt_3_S_Time_Up)
        {
          ...
          /***************************************************************************************
            ...
            //1500 is middle, 1600 is faster, 1400 is faster in opposite direction
            //200 is off, 1200 is max
            /*************************************************************************************/
          //Code we added

          //KEEP GOING STRAIGHT
          if (ui_Left_Line_Tracker_Data < (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance) && ui_Right_Line_Tracker_Data > (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) {
          ...
          if ((ui_Left_Line_Tracker_Data > (ui_Left_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) && (ui_Middle_Line_Tracker_Data > (ui_Middle_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) && (ui_Right_Line_Tracker_Data > (ui_Right_Line_Tracker_Dark - ui_Line_Tracker_Tolerance)) ) {
            ...
            //TURN AROUND
            if (step > 900 && step < 1220) {
              ui_Right_Motor_Speed = 1300;
              ui_Left_Motor_Speed = 1700;
            }

            //GO STRAIGHT BACK
            if (step > 1220 && step < 1700 ) {
              ui_Right_Motor_Speed = 1700;
              ui_Left_Motor_Speed = 1700;
            }
